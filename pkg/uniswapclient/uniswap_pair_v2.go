...
func bindUniswapPairV2(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := UniswapPairV2MetaData.GetAbi()
	if err != nil {
		return nil, err
	}
...
func (_UniswapPairV2 *UniswapPairV2Caller) Allowance(opts *bind.CallOpts, arg0 common.Address, arg1 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _UniswapPairV2.contract.Call(opts, &out, "allowance", arg0, arg1)
...
//
// Solidity: function allowance(address , address ) view returns(uint256)
func (_UniswapPairV2 *UniswapPairV2Session) Allowance(arg0 common.Address, arg1 common.Address) (*big.Int, error) {
	return _UniswapPairV2.Contract.Allowance(&_UniswapPairV2.CallOpts, arg0, arg1)
}

// Allowance is a free data retrieval call binding the contract method 0xdd62ed3e.
//
// Solidity: function allowance(address , address ) view returns(uint256)
func (_UniswapPairV2 *UniswapPairV2CallerSession) Allowance(arg0 common.Address, arg1 common.Address) (*big.Int, error) {
	return _UniswapPairV2.Contract.Allowance(&_UniswapPairV2.CallOpts, arg0, arg1)
}
...
func (_UniswapPairV2 *UniswapPairV2Caller) BalanceOf(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _UniswapPairV2.contract.Call(opts, &out, "balanceOf", arg0)
...
//
// Solidity: function balanceOf(address ) view returns(uint256)
func (_UniswapPairV2 *UniswapPairV2Session) BalanceOf(arg0 common.Address) (*big.Int, error) {
	return _UniswapPairV2.Contract.BalanceOf(&_UniswapPairV2.CallOpts, arg0)
}

// BalanceOf is a free data retrieval call binding the contract method 0x70a08231.
//
// Solidity: function balanceOf(address ) view returns(uint256)
func (_UniswapPairV2 *UniswapPairV2CallerSession) BalanceOf(arg0 common.Address) (*big.Int, error) {
	return _UniswapPairV2.Contract.BalanceOf(&_UniswapPairV2.CallOpts, arg0)
}
...
func (_UniswapPairV2 *UniswapPairV2Caller) Nonces(opts *bind.CallOpts, arg0 common.Address) (*big.Int, error) {
	var out []interface{}
	err := _UniswapPairV2.contract.Call(opts, &out, "nonces", arg0)
...
//
// Solidity: function nonces(address ) view returns(uint256)
func (_UniswapPairV2 *UniswapPairV2Session) Nonces(arg0 common.Address) (*big.Int, error) {
	return _UniswapPairV2.Contract.Nonces(&_UniswapPairV2.CallOpts, arg0)
}

// Nonces is a free data retrieval call binding the contract method 0x7ecebe00.
//
// Solidity: function nonces(address ) view returns(uint256)
func (_UniswapPairV2 *UniswapPairV2CallerSession) Nonces(arg0 common.Address) (*big.Int, error) {
	return _UniswapPairV2.Contract.Nonces(&_UniswapPairV2.CallOpts, arg0)
}
...
func (_UniswapPairV2 *UniswapPairV2Transactor) Initialize(opts *bind.TransactOpts, _token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _UniswapPairV2.contract.Transact(opts, "initialize", _token0, _token1)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _token0, address _token1) returns()
func (_UniswapPairV2 *UniswapPairV2Session) Initialize(_token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _UniswapPairV2.Contract.Initialize(&_UniswapPairV2.TransactOpts, _token0, _token1)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _token0, address _token1) returns()
func (_UniswapPairV2 *UniswapPairV2TransactorSession) Initialize(_token0 common.Address, _token1 common.Address) (*types.Transaction, error) {
	return _UniswapPairV2.Contract.Initialize(&_UniswapPairV2.TransactOpts, _token0, _token1)
}
